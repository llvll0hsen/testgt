...
install.packages("lazyeval", repos = "https://cloud.r-project.org/", dependencies=TRUE)
...
install.packages("mime", repos = "https://cloud.r-project.org/", dependencies=TRUE)
install.packages("nlme", repos = "https://cloud.r-project.org/", dependencies=TRUE)
install.packages("plyr", repos = "https://cloud.r-project.org/", dependencies=TRUE)
install.packages("quantreg", repos = "https://cloud.r-project.org/", dependencies=TRUE)
install.packages("plyr", repos = "https://cloud.r-project.org/", dependencies=TRUE)
install.packages("repr", repos = "https://cloud.r-project.org/", dependencies=TRUE)
...
install.packages("tidyselect", repos = "https://cloud.r-project.org/", dependencies=TRUE)
...
install.packages("splines", repos = "https://cloud.r-project.org/", dependencies=TRUE)
